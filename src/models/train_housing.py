...
class HousingModelTrainer:
    ...
    def __init__(self, experiment_name: str = None):
        ...
        """
        self.experiment_name = experiment_name or f"housing_prediction_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
    ...
    def plot_predictions(self, y_true: pd.Series, y_pred: np.ndarray, model_name: str) -> str:
        """
        ...
        for model_name in self.models.keys():
            try:
                ...
                with mlflow.start_run(run_name=f"{model_name}_training"):
                    ...
                    predictions_plot = self.plot_predictions(y_test, model.predict(X_test), model_name)
