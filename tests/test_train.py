...
class TestDataPreprocessing:
    ...
    def test_iris_data_preprocessing(self, sample_iris_data):
        ...
        assert all(col in sample_iris_data.columns for col in ['SepalLengthCm', 'SepalWidthCm', 'PetalLengthCm', 'PetalWidthCm', 'Species'])
        ...
        assert all(species in ['Iris-setosa', 'Iris-versicolor', 'Iris-virginica'] for species in unique_species)
    ...
    def test_housing_data_preprocessing(self, sample_housing_data):
        ...
        assert all(val in valid_ocean_values for val in sample_housing_data['ocean_proximity'].unique())
    ...
    def test_one_hot_encoding(self, sample_housing_data):
        ...
        assert encoded_data.shape[1] == len(sample_housing_data['ocean_proximity'].unique()) - 1
...
class TestModelTraining:
    ...
    @pytest.mark.skipif(not TRAINING_MODULES_AVAILABLE, reason="Training modules not available")
    ...
    def test_model_with_scaler_saving(self, mock_housing_model, mock_feature_scaler, temp_test_dir):
        ...
        try:
            ...
            model_data = {
                'model': mock_housing_model,
                'scaler': mock_feature_scaler
            }
...
class TestModelEvaluation:
    ...
    def test_iris_model_evaluation(self, sample_iris_data):
        ...
        # Prepare data
        X = sample_iris_data[['SepalLengthCm', 'SepalWidthCm', 'PetalLengthCm', 'PetalWidthCm']]
